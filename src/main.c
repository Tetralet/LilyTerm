...
#endif
{
	...
	g_debug("GEOMETRY_HAD_BEEN_RESIZE_ONCE_MASK = 0x%X", GEOMETRY_HAD_BEEN_RESIZE_ONCE_MASK);
	g_debug("GEOMETRY_RESIZE_TWICE_EXCEPT_PAGE_NAME = 0x%X", GEOMETRY_RESIZE_TWICE_EXCEPT_PAGE_NAME);
	g_debug("GEOMETRY_RESIZE_ONCE_EXCEPT_PAGE_NAME = 0x%X", GEOMETRY_RESIZE_ONCE_EXCEPT_PAGE_NAME);
#endif
