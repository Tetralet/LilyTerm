...
typedef enum {
	...
	GEOMETRY_UPDATE_PAGE_NAME_TWICE		=   0x2,
	GEOMETRY_UPDATE_PAGE_NAME		= GEOMETRY_UPDATE_PAGE_NAME_RESIZING | GEOMETRY_UPDATE_PAGE_NAME_TWICE,
	...
	GEOMETRY_SHOW_HIDE_TAB_BAR_RESIZING	=   0x4,
	GEOMETRY_SHOW_HIDE_TAB_BAR_TWICE	=   0x8,
	GEOMETRY_SHOW_HIDE_TAB_BAR_ONCE		=  0x10,
	GEOMETRY_SHOW_HIDE_TAB_BAR		= GEOMETRY_SHOW_HIDE_TAB_BAR_RESIZING | GEOMETRY_SHOW_HIDE_TAB_BAR_TWICE |
						  GEOMETRY_SHOW_HIDE_TAB_BAR_ONCE,

	// 0000 0000 0x10 0000 (0x0060): Changing Themes.
	GEOMETRY_CHANGING_THEME_RESIZING	=  0x20,
	GEOMETRY_CHANGING_THEME_TWICE		=  0x40,
	GEOMETRY_CHANGING_THEME			= GEOMETRY_CHANGING_THEME_RESIZING | GEOMETRY_CHANGING_THEME_TWICE,

	// 0000 00yx 1000 0000 (0x0380): Change the vte font, It should only run window_size_request() once.
	GEOMETRY_CHANGING_FONT_RESIZING		=  0x80,
	GEOMETRY_CHANGING_FONT_TWICE		= 0x100,
	GEOMETRY_CHANGING_FONT_ONCE		= 0x200,
	GEOMETRY_CHANGING_FONT			= GEOMETRY_CHANGING_FONT_RESIZING | GEOMETRY_CHANGING_FONT_TWICE | GEOMETRY_CHANGING_FONT_ONCE,

	// 0000 x100 0000 0000 (0x0C00): Hide/Show scroll_bar
	GEOMETRY_SHOW_HIDE_SCROLL_BAR_RESIZING	= 0x400,
	GEOMETRY_SHOW_HIDE_SCROLL_BAR_TWICE	= 0x800,
	GEOMETRY_SHOW_HIDE_SCROLL_BAR		= GEOMETRY_SHOW_HIDE_SCROLL_BAR_RESIZING | GEOMETRY_SHOW_HIDE_SCROLL_BAR_TWICE,

	// 1010 1001 0100 1010 (0xA94A): Check for x, Make y only run window_size_request() once.
	GEOMETRY_NEEDS_RUN_SIZE_REQUEST_MASK	= GEOMETRY_UPDATE_PAGE_NAME_TWICE | GEOMETRY_SHOW_HIDE_TAB_BAR_TWICE |
						  GEOMETRY_CHANGING_THEME_TWICE | GEOMETRY_CHANGING_FONT_TWICE |
						  GEOMETRY_SHOW_HIDE_SCROLL_BAR_TWICE,

	// 0101 0100 1010 0101 (0x54A5): Clean x and y, Means that it is resized.
	GEOMETRY_HAD_BEEN_RESIZE_ONCE_MASK	= GEOMETRY_UPDATE_PAGE_NAME_RESIZING | GEOMETRY_SHOW_HIDE_TAB_BAR_RESIZING |
						  GEOMETRY_CHANGING_THEME_RESIZING | GEOMETRY_CHANGING_FONT_RESIZING |
						  GEOMETRY_SHOW_HIDE_SCROLL_BAR_RESIZING,

	// 1111 1101 1110 1111 (0xFDEF): The mask result after check for x, but skip [Updating Page Name].
	GEOMETRY_RESIZE_TWICE_EXCEPT_PAGE_NAME	= 0xFFFF ^ GEOMETRY_SHOW_HIDE_TAB_BAR_ONCE ^ GEOMETRY_CHANGING_FONT_ONCE,

	// 0101 0110 1011 0101 (0x56B5): The mask result after check for y, but skip [Updating Page Name].
	GEOMETRY_RESIZE_ONCE_EXCEPT_PAGE_NAME	= 0xFFFF ^ GEOMETRY_UPDATE_PAGE_NAME_TWICE ^ GEOMETRY_SHOW_HIDE_TAB_BAR_TWICE
							 ^ GEOMETRY_CHANGING_THEME_TWICE ^ GEOMETRY_CHANGING_FONT_TWICE
							 ^ GEOMETRY_SHOW_HIDE_SCROLL_BAR_TWICE,
