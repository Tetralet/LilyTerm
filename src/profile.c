	...
	{{0, "",
	 ...
	 {6, "TODO: solarized light",
	  {{ 0, 0x0000, 0x2b2b, 0x3636 },
	   ...
	   { 0, 0x4c4c, 0x4c4c, 0x4c4c },
	   { 0, 0xa8a8, 0x3030, 0x3030 },
	   { 0, 0x2020, 0x8888, 0x2020 },
	   { 0, 0xa8a8, 0x8888, 0x0000 },
	   { 0, 0x5555, 0x5555, 0x9898 },
	   { 0, 0x8888, 0x3030, 0x8888 },
	   { 0, 0x3030, 0x8888, 0x8888 },
	   { 0, 0xd8d8, 0xd8d8, 0xd8d8 }}},
	 {7, "TODO: solarized dark",
	   {{ 0, 0x0000, 0x2b2b, 0x3636 },
	    { 0, 0xcbcb, 0x4b4b, 0x1616 },
	    { 0, 0x5858, 0x6e6e, 0x7575 },
	    { 0, 0x6565, 0x7b7b, 0x8383 },
	    ...
	    { 0, 0x3030, 0x8888, 0x8888 },
	    { 0, 0xd8d8, 0xd8d8, 0xd8d8 }}},
	 {8, "solarized orig",            // Source: http://ethanschoonover.com/solarized#the-values
