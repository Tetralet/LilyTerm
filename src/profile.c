...
struct Color_Theme color_theme[THEME] =
	...
	{"rxvt",
	 {{ 0, 0x0000, 0x0000, 0x0000 },
	  ...
	  { 0, 0xffff, 0xffff, 0xffff }}},
	{"solarized",
	 {{ 0, 0x1c1c, 0x1c1c, 0x1c1c },
	  { 0, 0x2626, 0x2626, 0x2626 },
	  { 0, 0x5858, 0x5858, 0x5858 },
	  { 0, 0x6262, 0x6262, 0x6262 },
	  { 0, 0x8080, 0x8080, 0x8080 },
	  { 0, 0x8a8a, 0x8a8a, 0x8a8a },
	  { 0, 0xe4e4, 0xe4e4, 0xe4e4 },
	  { 0, 0xffff, 0xffff, 0xd7d7 },
	  { 0, 0xafaf, 0x8787, 0x0000 },
	  { 0, 0xd7d7, 0x5f5f, 0x0000 },
	  { 0, 0xd7d7, 0x0000, 0x0000 },
	  { 0, 0xafaf, 0x0000, 0x5f5f },
	  { 0, 0x5f5f, 0x5f5f, 0xafaf },
	  { 0, 0x0000, 0x8787, 0xffff },
	  { 0, 0x0000, 0xafaf, 0xafaf },
	  { 0, 0x5f5f, 0x8787, 0x0000 }}},
	{"grayscale",
	 {{ 0, 0x0000, 0x0000, 0x0000 },
	  { 0, 0x3f3f, 0x3f3f, 0x3f3f },
