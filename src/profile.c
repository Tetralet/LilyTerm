...
struct Color_Theme color_theme[THEME] =
	...
	{"solarized light",
	 {{ 0, 0x0707, 0x3636, 0x4242 },
	  ...
	  { 0, 0x0c0c, 0x6363, 0x7a7a },
	  { 0, 0xe6e6, 0x3434, 0x3131 },
	  { 0, 0x9f9f, 0xb7b7, 0x0000 },
	  { 0, 0xcbcb, 0x9999, 0x0000 },
	  { 0, 0x2828, 0x9393, 0xdfdf },
	  { 0, 0xe0e0, 0x3939, 0x8a8a },
	  { 0, 0x3131, 0xbdbd, 0xb2b2 },
	  { 0, 0xf3f3, 0xecec, 0xd9d9 }}},
	{"solarized dark",
	 {{ 0, 0x0404, 0x2525, 0x2e2e },
	  { 0, 0x9a9a, 0x2323, 0x2020 },
	  { 0, 0x5d5d, 0x6b6b, 0x0000 },
	  { 0, 0x7e7e, 0x5f5f, 0x0000 },
	  { 0, 0x1a1a, 0x6161, 0x9393 },
	  { 0, 0x9393, 0x2525, 0x5b5b },
	  { 0, 0x1d1d, 0x7070, 0x6a6a },
	  { 0, 0xa6a6, 0xa2a2, 0x9595 },
	  { 0, 0x0707, 0x3636, 0x4242 },
	  { 0, 0xdcdc, 0x3232, 0x2f2f },
	  { 0, 0x8585, 0x9999, 0x0000 },
	  { 0, 0xb5b5, 0x8989, 0x0000 },
