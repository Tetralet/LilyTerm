	...
	{{"",
	 ...
	 {"rxvt",
	  {{ 0, 0x0000, 0x0000, 0x0000 },
	   ...
	   { 0, 0xffff, 0xffff, 0xffff }}},
	 {"solarized",
	  {{ 0, 0x0e0e, 0x0e0e, 0x0d0d },
	   { 0, 0x5858, 0x1414, 0x1212 },
	   { 0, 0x2727, 0x3d3d, 0x0000 },
	   { 0, 0x5454, 0x3636, 0x0000 },
	   { 0, 0x0f0f, 0x3737, 0x5454 },
	   { 0, 0x5454, 0x1515, 0x3434 },
	   { 0, 0x1010, 0x4040, 0x3c3c },
	   { 0, 0x5f5f, 0x5c5c, 0x5555 },
	   { 0, 0xa7a7, 0xa2a2, 0x9494 },
	   { 0, 0xf1f1, 0x3636, 0x3333 },
	   { 0, 0x8a8a, 0xd6d6, 0x0000 },
	   { 0, 0xeded, 0x9a9a, 0x0000 },
	   { 0, 0x2a2a, 0x9c9c, 0xeded },
	   { 0, 0xeded, 0x3c3c, 0x9292 },
	   { 0, 0x3838, 0xd9d9, 0xcccc },
	   { 0, 0xf8f8, 0xf1f1, 0xdddd }}},
	 {"grayscale",
	  {{ 0, 0x0000, 0x0000, 0x0000 },
	   { 0, 0x3f3f, 0x3f3f, 0x3f3f },
